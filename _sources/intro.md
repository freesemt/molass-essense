...
This document describes the theoretical aspect of the library. You can read the chapters of the left sidebar, for ordinary use, in the listed order. Otherwise, glance over the contents or use the search box to find what you are interested in.
